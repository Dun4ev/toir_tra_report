...
- **v3.0:** Добавлен выбор отправителя трансмиттала с сохранением справочника в `settings.json` и автозаполнением именованной ячейки `pripmem` в шаблоне.
